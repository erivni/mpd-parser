...
QUnit.test('keySystem info for adaptationSet - lowercase UUIDs', function(assert) {
  const NOW = Date.now();
      ...
      <Period>
        <AdaptationSet mimeType="video/mp4" >
          ...
          <ContentProtection value="MSPR 2.0" schemeIdUri="urn:uuid:9a04f079-9840-4286-ab92-e65be0885f95">
              <cenc:pssh>${playreadyPsshB64}</cenc:pssh>
          ...
          <ContentProtection value="Widevine" schemeIdUri="urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed">
              <cenc:pssh>${widevinePsshB64}</cenc:pssh>
          </ContentProtection>
          <Role value="main"></Role>
          <SegmentTemplate></SegmentTemplate>
          <Representation
...
QUnit.test('keySystem info for adaptationSet - uppercase UUIDs', function(assert) {
  const NOW = Date.now();
...
QUnit.test('keySystem info for representation adaptationSet  - prefer representation', function(assert) {
  const NOW = Date.now();

  const adaptationWidevinePsshB64 = 'AAAANHBzc2gAAAAA7e+LqXnWSs6jyCfc1R0h7QAAABQIARIQCHJ4bvnnRl+jok5bDvj6AQ==';
  const representationWidevinePsshB64 = 'AAAANHBzc2gAAAAA7e+LqXnWSs6jyCfc1R0h7QAAABQIARIQCHJ4bvnnRl+jok5bDvj6RQ==';
  const adaptationPlayreadyPsshB64 = '';
  const representationPlayreadyPsshB64 = '';
    ...
    <MPD mediaPresentationDuration="PT30S" xmlns:cenc="urn:mpeg:cenc:2013">
      ...
      <Period>
        <AdaptationSet mimeType="video/mp4" >
            <ContentProtection schemeIdUri="urn:mpeg:dash:mp4protection:2011" value="cenc" cenc:default_KID="0872786E-F9E7-465F-A3A2-4E5B0EF8FA45" />
            <ContentProtection value="MSPR 2.0" schemeIdUri="urn:uuid:9A04F079-9840-4286-AB92-E65BE0885F95">
                <cenc:pssh>${adaptationPlayreadyPsshB64}</cenc:pssh>
                <pro xmlns="urn:microsoft:playready"></pro>
            </ContentProtection>
            <ContentProtection value="Widevine" schemeIdUri="urn:uuid:EDEF8BA9-79D6-4ACE-A3C8-27DCD51D21ED">
                <cenc:pssh>${adaptationWidevinePsshB64}</cenc:pssh>
            </ContentProtection>
          <Role value="main"></Role>
          <SegmentTemplate></SegmentTemplate>
          <Representation
            ...
            <ContentProtection schemeIdUri="urn:mpeg:dash:mp4protection:2011" value="cenc" cenc:default_KID="0872786E-F9E7-465F-A3A2-4E5B0EF8FA45" />
            <ContentProtection value="MSPR 2.0" schemeIdUri="urn:uuid:9A04F079-9840-4286-AB92-E65BE0885F95">
                <cenc:pssh>${representationPlayreadyPsshB64}</cenc:pssh>
                <pro xmlns="urn:microsoft:playready"></pro>
            </ContentProtection>
            <ContentProtection value="Widevine" schemeIdUri="urn:uuid:EDEF8BA9-79D6-4ACE-A3C8-27DCD51D21ED">
                <cenc:pssh>${representationWidevinePsshB64}</cenc:pssh>
            </ContentProtection>
          </Representation>
        </AdaptationSet>
      </Period>
      ...
      attributes: {
        ...
        'contentProtection': {
          'com.microsoft.playready': {
            ...
            pssh: representationPlayreadyPsshB64
          },
          'com.widevine.alpha': {
            attributes: {
              schemeIdUri: 'urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed',
            ...
            pssh: representationWidevinePsshB64
          }
        },
        'height': 404,
        'id': 'test',
...
QUnit.test('keySystem info under pssh for adaptationSet - lowercase UUIDs', function(assert) {
  const NOW = Date.now();
    ...
    <MPD mediaPresentationDuration="PT30S" xmlns:cenc="urn:mpeg:cenc:2013">
      ...
      <Period>
        <AdaptationSet mimeType="video/mp4" >
          <ContentProtection schemeIdUri="urn:mpeg:dash:mp4protection:2011" value="cenc" cenc:default_KID="0872786e-f9e7-465f-a3a2-4e5b0ef8fa45" />
          <ContentProtection value="MSPR 2.0" schemeIdUri="urn:uuid:9a04f079-9840-4286-ab92-e65be0885f95">
              <pssh>${playreadyPsshB64}</pssh>
              <pro xmlns="urn:microsoft:playready"></pro>
          </ContentProtection>
          <ContentProtection value="Widevine" schemeIdUri="urn:uuid:edef8ba9-79d6-4ace-a3c8-27dcd51d21ed">
              <pssh>${widevinePsshB64}</pssh>
          </ContentProtection>
          <Role value="main"></Role>
          <SegmentTemplate></SegmentTemplate>
          <Representation
...
QUnit.test('keySystem info under pssh for adaptationSet - uppercase UUIDs', function(assert) {
  const NOW = Date.now();
...
QUnit.test('keySystem info under pssh for representation - lowercase UUIDs', function(assert) {
  const NOW = Date.now();
...
QUnit.test('keySystem info under pssh for representation - uppercase UUIDs', function(assert) {
  const NOW = Date.now();
...
QUnit.test('keySystem info under pssh for representation adaptationSet  - prefer representation', function(assert) {
  const NOW = Date.now();
    ...
    <MPD mediaPresentationDuration="PT30S" xmlns:cenc="urn:mpeg:cenc:2013">
      ...
      <Period>
        <AdaptationSet mimeType="video/mp4" >
            <ContentProtection schemeIdUri="urn:mpeg:dash:mp4protection:2011" value="cenc" cenc:default_KID="0872786E-F9E7-465F-A3A2-4E5B0EF8FA45" />
            <ContentProtection value="MSPR 2.0" schemeIdUri="urn:uuid:9A04F079-9840-4286-AB92-E65BE0885F95">
                <pssh>${adaptationPlayreadyPsshB64}</pssh>
                <pro xmlns="urn:microsoft:playready"></pro>
            </ContentProtection>
            <ContentProtection value="Widevine" schemeIdUri="urn:uuid:EDEF8BA9-79D6-4ACE-A3C8-27DCD51D21ED">
                <pssh>${adaptationWidevinePsshB64}</pssh>
            </ContentProtection>
          <Role value="main"></Role>
          <SegmentTemplate></SegmentTemplate>
          <Representation
            ...
            <ContentProtection schemeIdUri="urn:mpeg:dash:mp4protection:2011" value="cenc" cenc:default_KID="0872786E-F9E7-465F-A3A2-4E5B0EF8FA45" />
            <ContentProtection value="MSPR 2.0" schemeIdUri="urn:uuid:9A04F079-9840-4286-AB92-E65BE0885F95">
                <pssh>${representationPlayreadyPsshB64}</pssh>
                <pro xmlns="urn:microsoft:playready"></pro>
            </ContentProtection>
            <ContentProtection value="Widevine" schemeIdUri="urn:uuid:EDEF8BA9-79D6-4ACE-A3C8-27DCD51D21ED">
                <pssh>${representationWidevinePsshB64}</pssh>
            </ContentProtection>
          </Representation>
        </AdaptationSet>
      </Period>
...
QUnit.test(
  ...
  `), { NOW, programIdFn: programId }).representationInfo);
